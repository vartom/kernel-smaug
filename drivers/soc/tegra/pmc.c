...
#define  PMC_CNTRL_PWRREQ_POLARITY	(8)   /* core power req polarity */
#define  PMC_CNTRL_PWRREQ_OE		(9)   /* core power req enable */
...
#define  IO_DPD_CSIA			(1U << 0)
#define  IO_DPD_CSIB			(1U << 1)
#define  IO_DPD_DSI			(1U << 2)
#define  IO_DPD_MIPI_BIAS		(1U << 3)
#define  IO_DPD_PEX_BIAS		(1U << 4)
#define  IO_DPD_PEX_CLK1		(1U << 5)
#define  IO_DPD_PEX_CLK2		(1U << 6)
#define  IO_DPD_PEX_CLK3		(1U << 7)
#define  IO_DPD_DAC			(1U << 8)
#define  IO_DPD_USB0			(1U << 9)
#define  IO_DPD_USB1			(1U << 10)
#define  IO_DPD_USB2			(1U << 11)
#define  IO_DPD_USB_BIAS		(1U << 12)
#define  IO_DPD_NAND			(1U << 13)
#define  IO_DPD_UART			(1U << 14)
#define  IO_DPD_BB			(1U << 15)
#define  IO_DPD_VI			(1U << 16)
#define  IO_DPD_AUDIO			(1U << 17)
#define  IO_DPD_LCD			(1U << 18)
#define  IO_DPD_HSIC			(1U << 19)
...
#define  IO_DPD2_PEX_CNTRL		(1U << 0)
#define  IO_DPD2_SDMMC1			(1U << 1)
#define  IO_DPD2_SDMMC3			(1U << 2)
#define  IO_DPD2_SDMMC4			(1U << 3)
#define  IO_DPD2_CAM			(1U << 4)
#define  IO_DPD2_RES_RAIL		(1U << 5)
#define  IO_DPD2_HV			(1U << 6)
#define  IO_DPD2_DSIB			(1U << 7)
#define  IO_DPD2_DSIC			(1U << 8)
#define  IO_DPD2_DSID			(1U << 9)
#define  IO_DPD2_CSIC			(1U << 10)
#define  IO_DPD2_CSID			(1U << 11)
#define  IO_DPD2_CSIE			(1U << 12)
...
void tegra_pmc_enter_suspend_mode(enum tegra_suspend_mode mode)
{
	...
	case TEGRA_SUSPEND_LP0:
		...
		/* Set warmboot flag */
		boot_flag = readl(pmc->scratch + pmc->soc->regs->scratch0);
		writel(boot_flag | 1, pmc->scratch + pmc->soc->regs->scratch0);
